...
import '/todo/todo_component/todo_component_widget.dart';
...
class _TodoListWidgetState extends State<TodoListWidget> {
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view', parameters: {'screen_name': 'todoList'});
  }
          ...
          actions: [
            Padding(
              ...
              child: FlutterFlowIconButton(
                ...
                onPressed: () async {
                  logFirebaseEvent('TODO_LIST_PAGE_add_circle_ICN_ON_TAP');
                    ...
                    builder: (context) {
                      return GestureDetector(
                        ...
                        child: Padding(
                          ...
                          child: const TodoComponentWidget(),
                        ),
                      );
                    },
                                    ...
                                    children: [
                                      Padding(
                                        ...
                                        child: InkWell(
                                          ...
                                          onTap: () async {
                                            logFirebaseEvent(
                                                'TODO_LIST_PAGE_Icon_4agil5vb_ON_TAP');
                                            logFirebaseEvent(
                                                'Icon_alert_dialog');
