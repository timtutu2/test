...
import 'mainpost_model.dart';
export 'mainpost_model.dart';

class MainpostWidget extends StatefulWidget {
  const MainpostWidget({
    super.key,
    required this.catestring,
  });

  final String? catestring;
...
class _MainpostWidgetState extends State<MainpostWidget>
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MainpostModel());

    logFirebaseEvent('screen_view', parameters: {'screen_name': 'mainpost'});
    // On page load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      logFirebaseEvent('MAINPOST_PAGE_mainpost_ON_INIT_STATE');
      if (FFAppState().lasttimeOverride == null) {
        logFirebaseEvent('mainpost_update_app_state');
        FFAppState().lasttimeOverride = getCurrentTimestamp;
        setState(() {});
      }
      logFirebaseEvent('mainpost_custom_action');
      ...
      if (_model.isoverride!) {
        ...
        setState(() {});
        logFirebaseEvent('mainpost_clear_query_cache');
        FFAppState().clearPostFilterCache();
        logFirebaseEvent('mainpost_wait__delay');
      ...
      if (!FFAppState().EULAgreementApp) {
        logFirebaseEvent('mainpost_bottom_sheet');
    ...
    _model.textFieldFocusNode!.addListener(
      () async {
        logFirebaseEvent('MAINPOST_TextField_00e0detd_ON_FOCUS_CHA');
                    ...
                    child: Row(
                      ...
                      children: [
                        FlutterFlowIconButton(
                          ...
                          onPressed: () async {
                            logFirebaseEvent(
                                'MAINPOST_chevron_left_sharp_ICN_ON_TAP');
                                  ...
                                  child: Padding(
                                    ...
                                    child: TextFormField(
                                      ...
                                      onFieldSubmitted: (_) async {
                                        logFirebaseEvent(
                                            'MAINPOST_TextField_00e0detd_ON_TEXTFIELD');
                                        logFirebaseEvent(
                        ...
                        if (_model.crossShow)
                          Padding(
                            ...
                            child: FlutterFlowIconButton(
                              ...
                              onPressed: () async {
                                logFirebaseEvent(
                                    'MAINPOST_PAGE_close_ICN_ON_TAP');
                                logFirebaseEvent(
                            ...
                            child: FutureBuilder<int>(
                              ...
                              builder: (context, snapshot) {
                                ...
                                return InkWell(
                                  ...
                                  onTap: () async {
                                    logFirebaseEvent(
                                        'MAINPOST_PAGE_Badge_4vpsyzvj_ON_TAP');
                    ...
                    child: Column(
                      ...
                      children: [
                        Expanded(
                          flex: 14,
                          child: Container(
                            height: MediaQuery.sizeOf(context).height * 0.581,
                            decoration: const BoxDecoration(),
                            child: Builder(
                              builder: (context) {
                                if (_model.showSearchinMainpost == false) {
                                  return RefreshIndicator(
                                    key: const Key('RefreshIndicator_5chc82n9'),
                                    onRefresh: () async {
                                      logFirebaseEvent(
                                          'MAINPOST_ListView_kfsv4rqb_ON_PULL_TO_RE');
                                      logFirebaseEvent(
                                                  ...
                                                  children: [
                                                    Padding(
                                                      ...
                                                      child: InkWell(
                                                        ...
                                                        onTap: () async {
                                                          logFirebaseEvent(
                                                              'MAINPOST_PAGE_Column_jk1kjmpj_ON_TAP');
                                                          logFirebaseEvent(
                                                                      ...
                                                                      return Row(
                                                                        ...
                                                                        children: [
                                                                                  ...
                                                                                  return Stack(
                                                                                    ...
                                                                                    children: [
                                                                                      InkWell(
                                                                                        ...
                                                                                        highlightColor: Colors.transparent,
                                                                                        onTap: () async {
                                                                                          logFirebaseEvent('MAINPOST_CircleImage_e61zusx6_ON_TAP');
                                                                                          logFirebaseEvent('CircleImage_custom_action');
                                                                                          _model.existuserCopy = await actions.ifdofisexistUser(
                                                                                            rowUsersRecord.reference,
                                                                                          );
                                                                                          if (_model.existuserCopy!) {
                                                                                              ...
                                                                                              child: Column(
                                                                                                ...
                                                                                                children: [
                                                                                                  InkWell(
                                                                                                    ...
                                                                                                    highlightColor: Colors.transparent,
                                                                                                    onTap: () async {
                                                                                                      logFirebaseEvent('MAINPOST_PAGE_user_name_ON_TAP');
                                                                          ...
                                                                          FlutterFlowIconButton(
                                                                            ...
                                                                            onPressed:
                                                                                () async {
                                                                              logFirebaseEvent('MAINPOST_keyboard_control_ICN_ON_TAP');
                                                                          ...
                                                                          builder:
                                                                            ...
                                                                            if (valueOrDefault<bool>(
                                                                              ...
                                                                              return InkWell(
                                                                                ...
                                                                                highlightColor: Colors.transparent,
                                                                                onTap: () async {
                                                                                  logFirebaseEvent('MAINPOST_PAGE_Image_blyly1jk_ON_TAP');
                                                                          ...
                                                                          Builder(
                                                                            builder:
                                                                              ...
                                                                              if (listViewPostRecord.postStatus == true) {
                                                                                return Builder(
                                                                                  builder: (context) {
                                                                                    if ((listViewPostRecord.needApply == true) || (listViewPostRecord.hasNeedApply() == false)) {
                                                                                                    ...
                                                                                                    if (listViewPostRecord.joinMember.contains(currentUserReference) && (listViewPostRecord.postUser != currentUserReference)) {
                                                                                                      ...
                                                                                                      return FFButtonWidget(
                                                                                                        onPressed: ((listViewPostRecord.postUser == currentUserReference) || !listViewPostRecord.postStatus || listViewPostRecord.joinMember.contains(currentUserReference))
                                                                                                            ? null
                                                                                                            : () async {
                                                                                                                logFirebaseEvent('MAINPOST_PAGE_申請_BTN_ON_TAP');
                                                                                          ...
                                                                                          if (listViewPostRecord.joinMember.contains(currentUserReference) && (listViewPostRecord.postUser != currentUserReference)) {
                                                                                            ...
                                                                                            return FFButtonWidget(
                                                                                              onPressed: ((listViewPostRecord.postUser == currentUserReference) || !listViewPostRecord.postStatus || listViewPostRecord.joinMember.contains(currentUserReference))
                                                                                                  ? null
                                                                                                  : () async {
                                                                                                      logFirebaseEvent('MAINPOST_PAGE_加入_BTN_ON_TAP');
                                                                                                      if (listViewPostRecord.chatOfPost != null) {
                                                                                                        ...
                                                                                                        _model.chatMainFilter1 = await actions.getDocReffromchat(
                                                                                                          listViewPostRecord.chatOfPost!,
                                                                                                        );
                                                                                                        logFirebaseEvent('Button_navigate_to');
                                                                                                        ...
                                                                                                        context.goNamed(
                                                                                                          ...
                                                                                                          queryParameters: {
                                                                                                            'chatRef': serializeParam(
                                                                                                              _model.chatMainFilter1,
                                                                                                              ParamType.Document,
                                                                                                            ),
                                                                                                          }.withoutNulls,
                                                                                                          extra: <String, dynamic>{
                                                                                                            'chatRef': _model.chatMainFilter1,
                                                                                                          },
                                                                                                        );
                                                                                                        ...
                                                                                                        _model.newChatMainfilter1 = ChatsRecord.getDocumentFromData({
                                                                                                          ...createChatsRecordData(
                                                                                                            userA: listViewPostRecord.postUser,
                                                                                                            userB: currentUserReference,
                                                                                                            lastMessage: '',
                                                                                                        ...
                                                                                                        await listViewPostRecord.reference.update({
                                                                                                          ...createPostRecordData(
                                                                                                            chatOfPost: _model.newChatMainfilter1?.reference,
                                                                                                          ),
                                                                                                          ...mapToFirestore(
                                                                                                            {
                                                                                                              'join_member': FieldValue.arrayUnion([currentUserReference]),
                                                                                                        ...
                                                                                                        context.goNamed(
                                                                                                          ...
                                                                                                          queryParameters: {
                                                                                                            'chatRef': serializeParam(
                                                                                                              _model.newChatMainfilter1,
                                                                                                              ParamType.Document,
                                                                                                            ),
                                                                                                          }.withoutNulls,
                                                                                                          extra: <String, dynamic>{
                                                                                                            'chatRef': _model.newChatMainfilter1,
                                                                                                          },
                                                                                                        );
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          onPressed:
                                                                              () async {
                                                                            logFirebaseEvent('MAINPOST_PAGE_更多_BTN_ON_TAP');
                                                                            logFirebaseEvent('Button_navigate_to');
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          onPressed:
                                                                              () async {
                                                                            logFirebaseEvent('MAINPOST_PAGE_收藏_BTN_ON_TAP');
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          onPressed:
                                                                              () async {
                                                                            logFirebaseEvent('MAINPOST_PAGE_隱藏_BTN_ON_TAP');
                                                                            if ((currentUserDocument?.hidePost.toList() ?? []).contains(listViewPostRecord.reference)) {
                                                                              logFirebaseEvent('Button_update_page_state');
                                                                              _model.showsharebutton = false;
                                                                              setState(() {});
                                                                            } else {
                                                    ...
                                                    children: [
                                                      Padding(
                                                        ...
                                                        child: InkWell(
                                                          ...
                                                          onTap: () async {
                                                            logFirebaseEvent(
                                                                'MAINPOST_PAGE_Column_o2p0y4hq_ON_TAP');
                                                            logFirebaseEvent(
                                                                'Column_update_page_state');
                                                            _model.showsharebutton =
                                                                false;
                                                                            ...
                                                                            builder:
                                                                              ...
                                                                              if (valueOrDefault<bool>(
                                                                                ...
                                                                                return InkWell(
                                                                                  ...
                                                                                  highlightColor: Colors.transparent,
                                                                                  onTap: () async {
                                                                                    logFirebaseEvent('MAINPOST_PAGE_Image_x72v7yhy_ON_TAP');
                                                                                    logFirebaseEvent('Image_navigate_to');
                                                                      ...
                                                                      if ((searchResultItem.limitPeopleNum !=
                                                                        ...
                                                                        Row(
                                                                          ...
                                                                          children: [
                                                                            ...
                                                                            Padding(
                                                                              padding: const EdgeInsetsDirectional.fromSTEB(4.0, 0.0, 5.0, 0.0),
                                                                              child: Text(
                                                                                                ...
                                                                                                onPressed: ((searchResultItem.postUser == currentUserReference) || !searchResultItem.postStatus || searchResultItem.joinMember.contains(currentUserReference))
                                                                                                    ...
                                                                                                    : () async {
                                                                                                        ...
                                                                                                        if (searchResultItem.chatOfPost != null) {
                                                                                                          ...
                                                                                                          logFirebaseEvent('Button_custom_action');
                                                                                                          _model.chatdocsecSearchsec = await actions.getDocReffromchat(
                                                                                                          ...
                                                                                                          context.goNamed(
                                                                                                            ...
                                                                                                            queryParameters: {
                                                                                                              'chatRef': serializeParam(
                                                                                                                _model.chatdocsecSearchsec,
                                                                                                                ParamType.Document,
                                                                                                              ),
                                                                                                            }.withoutNulls,
                                                                                                            extra: <String, dynamic>{
                                                                                                              'chatRef': _model.chatdocsecSearchsec,
                                                                                                            },
                                                                                                          );
                                                                                                          ...
                                                                                                          _model.newChatsecSearchsec = ChatsRecord.getDocumentFromData({
                                                                                                            ...createChatsRecordData(
                                                                                                              userA: searchResultItem.postUser,
                                                                                                              userB: currentUserReference,
                                                                                                              lastMessage: '',
                                                                                                          ...
                                                                                                          await searchResultItem.reference.update({
                                                                                                            ...createPostRecordData(
                                                                                                              chatOfPost: _model.newChatsecSearchsec?.reference,
                                                                                                            ),
                                                                                                            ...mapToFirestore(
                                                                                                              {
                                                                                                                'join_member': FieldValue.arrayUnion([currentUserReference]),
                                                                                                          ...
                                                                                                          context.goNamed(
                                                                                                            ...
                                                                                                            queryParameters: {
                                                                                                              'chatRef': serializeParam(
                                                                                                                _model.newChatsecSearchsec,
                                                                                                                ParamType.Document,
                                                                                                              ),
                                                                                                            }.withoutNulls,
                                                                                                            extra: <String, dynamic>{
                                                                                                              'chatRef': _model.newChatsecSearchsec,
                                                                                                            },
                                                                                                          );
