...
class ChatMessagesRecord extends FirestoreRecord {
  ...
  // "who_can_read" field.
  List<DocumentReference>? _whoCanRead;
  List<DocumentReference> get whoCanRead => _whoCanRead ?? const [];
  bool hasWhoCanRead() => _whoCanRead != null;
  ...
  void _initializeFields() {
    ...
    _whoCanRead = getDataList(snapshotData['who_can_read']);
  }
...
class ChatMessagesRecordDocumentEquality
  ...
  bool equals(ChatMessagesRecord? e1, ChatMessagesRecord? e2) {
    ...
    return e1?.user == e2?.user &&
        ...
        listEquality.equals(e1?.whoCanRead, e2?.whoCanRead);
  }
