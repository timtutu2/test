...
class ChatsRecord extends FirestoreRecord {
  ...
  // "post_of_chat" field.
  DocumentReference? _postOfChat;
  DocumentReference? get postOfChat => _postOfChat;
  bool hasPostOfChat() => _postOfChat != null;
  ...
  // "group_chat_photo" field.
  String? _groupChatPhoto;
  String get groupChatPhoto => _groupChatPhoto ?? '';
  bool hasGroupChatPhoto() => _groupChatPhoto != null;
  ...
  void _initializeFields() {
    ...
    _postOfChat = snapshotData['post_of_chat'] as DocumentReference?;
    _chatName = snapshotData['chat_name'] as String?;
    _groupChatPhoto = snapshotData['group_chat_photo'] as String?;
  }
...
Map<String, dynamic> createChatsRecordData({
  ...
  final firestoreData = mapToFirestore(
    <String, dynamic>{
      ...
      'post_of_chat': postOfChat,
      'chat_name': chatName,
      'group_chat_photo': groupChatPhoto,
    }.withoutNulls,
  );
...
class ChatsRecordDocumentEquality implements Equality<ChatsRecord> {
  ...
  bool equals(ChatsRecord? e1, ChatsRecord? e2) {
    ...
    return listEquality.equals(e1?.users, e2?.users) &&
        ...
        e1?.postOfChat == e2?.postOfChat &&
        e1?.chatName == e2?.chatName &&
        e1?.groupChatPhoto == e2?.groupChatPhoto;
  }
