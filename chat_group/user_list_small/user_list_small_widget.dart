                    ...
                    if (widget.userRef?.photoUrl != null &&
                      ...
                      return Stack(
                        children: [
                          ...
                          if (functions.verifyemail(widget.userRef?.email) ==
                              true)
                            const Align(
                      ...
                      return Padding(
                        ...
                        child: InkWell(
                          ...
                          onTap: () async {
                            logFirebaseEvent(
                                'USER_LIST_SMALL_Container_vf01s554_ON_TA');
                          ...
                          child: Container(
                            ...
                            child: Stack(
                              children: [
                                ...
                                if (functions
                                        .verifyemail(widget.userRef?.email) ==
                                    true)
                                  const Align(
                                    alignment: AlignmentDirectional(1.0, 1.0),
                                    child: Icon(
                  ...
                  child: Column(
                    ...
                    children: [
                      InkWell(
                        ...
                        onTap: () async {
                          logFirebaseEvent(
                              'USER_LIST_SMALL_Text_32a9m8ys_ON_TAP');
