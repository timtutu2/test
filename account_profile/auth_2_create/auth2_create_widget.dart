                                  ...
                                  child: SizedBox(
                                    ...
                                    child: TextFormField(
                                      ...
                                      decoration: InputDecoration(
                                        labelText: 'Email（建議使用nthu.edu信箱）',
                                ...
                                Padding(
                                  ...
                                  child: FFButtonWidget(
                                    onPressed: ((_model.emailAddressTextController
                                        ...
                                        : () async {
                                            logFirebaseEvent(
                                                'AUTH_2_CREATE_PAGE_建立帳戶_BTN_ON_TAP');
                                ...
                                Align(
                                  ...
                                  child: Padding(
                                    ...
                                    child: InkWell(
                                      ...
                                      onTap: () async {
                                        logFirebaseEvent(
                                            'AUTH_2_CREATE_RichText_lw2rc6eq_ON_TAP');
                                        logFirebaseEvent(
                                ...
                                Align(
                                  ...
                                  child: Padding(
                                    ...
                                    child: InkWell(
                                      ...
                                      onTap: () async {
                                        logFirebaseEvent(
                                            'AUTH_2_CREATE_RichText_pkw5q39t_ON_TAP');
                                        logFirebaseEvent(
                                            'RichText_launch_u_r_l');
                                        await launchURL(
                                            'https://net.nthu.edu.tw/netsys/mail:webmail');
                                      },
                                      child: RichText(
                                        textScaler:
                                            MediaQuery.of(context).textScaler,
